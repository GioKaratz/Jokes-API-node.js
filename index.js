...
app.get("/filter", (req, res) => {
  var jkType = req.query.type;
  var foundJokes = jokes.filter((joke) => joke.jokeType === jkType);
  res.json(foundJokes);
});
...
app.put("/jokes/:id", (req, res) => {
  ...
  var searchIndex = jokes.findIndex((joke) => joke.id === paramId);
  joke[searchIndex] = replacementJoke;
...
app.patch("/jokes/:id", (req, res) => {
  var paramId = parseInt(req.params.id);
  var foundJoke = jokes.find((joke) => joke.id === paramId);
